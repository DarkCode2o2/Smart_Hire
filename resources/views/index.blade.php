...
<body class="text-slate-900" id="top">
    ...
    <footer class="py-12 text-center border-t border-slate-200 bg-white">
        <div class="w-[300px] border-b border-slate-200 my-0 mx-auto pb-2">
            <a href="#top" class="text-3xl mb-2 font-extrabold tracking-tight text-blue-600">
                SmartHire<span class="text-slate-400">AI</span>
            </a>
        </div>
        <p class="text-slate-400  mt-2 text-sm">Designed by <a href="https://t.me/darkcode2o2" target="_blank" class="text-blue-700 font-semibold underline">DarkCode</a></p>
    </footer>
